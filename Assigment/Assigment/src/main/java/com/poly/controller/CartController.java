...
public class CartController {
	@Autowired //khởi tạo đối tượng lên repository
	// xử lý các business logic liên quan đến Product như CRUD, findAll, …..
	private ICartService cartService; 
	@Autowired
	private IUserService userService;
	   @GetMapping("/cart")
	    public String getCart(Model model) {  //model chia se dl vs view
