...
public interface IOrderDetailRepository extends JpaRepository<OrderDetail, Integer> {
	...
	@Query("Select SUM(o.quantity) from OrderDetail o where o.order.createDate = CURRENT_DATE() " //ngay hom nay
			+ "and o.order.status = 2 Group by o.heo Order by SUM(o.quantity) desc ") //giam
