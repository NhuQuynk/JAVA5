						...
						<div class="nav-item dropdown">
							...
							<div class="dropdown-menu">
								<a href="wishlist.html" class="dropdown-item">Wishlist</a> <a
									href="/login" class="dropdown-item">Login & Register</a> <a
        ...
        <div class="breadcrumb-wrap">
            <div class="container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Heo Detail</li>
                </ul>
            </div>
        </div>
        <!-- Breadcrumb End -->
                ...
                <div class="row">
                    <div class="col-lg-8">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-5">
                                    <div class="product-slider-single normal-slider">
                                        <img src="/storage/${heo.image }" alt="Product Image">
                                ...
                                <div class="col-md-7">
                                    <div class="product-content">
                                        <div class="title"><h2>${heo.name }</h2></div>
                                        <div class="ratting">
                                        ...
                                        <div class="p-size">
                                            <h4> Weight ${heo.weight } Kg</h4>
                                         
                                        </div>
                                        <div class="p-color">
                                            <h4>Color ${heo.color }</h4>
                        ...
                        <div class="product">
                            ...
                            <c:forEach var="heo" items="${related }">
                                <div class="col-lg-3">
